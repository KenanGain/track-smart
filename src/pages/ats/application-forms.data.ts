...
function hiringAtsForms(): ApplicationFormDef[] {
    ...
    return [
        ...
        mk('form-ats-road-test', 'Road Test', 'Road Test Evaluation', 'Road test evaluation, FMCSA §391.31 record, certification, and §391.33 equivalent.', [
            // ── Driver / equipment details (top of the form) ──
            ...
            { id: 'f-ats-rt-state', type: 'text', required: false, options: [], instruction: '', label: 'State', width: 'half' },
            { id: 'f-ats-rt-class', type: 'text', required: false, options: [], instruction: '', label: 'Class', width: 'half' },
            ...
            { id: 'f-ats-rt-length', type: 'text', required: false, options: [], instruction: '', label: 'Length of test', width: 'half' },
            { id: 'f-ats-rt-miles-from', type: 'text', required: false, options: [], instruction: '', label: 'Miles from / in', width: 'half' },
            { id: 'f-ats-rt-miles-to', type: 'text', required: false, options: [], instruction: '', label: 'Miles to', width: 'half' },
            { id: 'f-ats-rt-weather', type: 'text', required: false, options: [], instruction: '', label: 'Weather conditions', width: 'half' },
            { id: 'f-ats-rt-start', type: 'text', required: false, options: [], instruction: '', label: 'Start time', width: 'half' },
            { id: 'f-ats-rt-finish', type: 'text', required: false, options: [], instruction: '', label: 'Finish time', width: 'half' },
            { id: 'f-ats-rt-date', type: 'date', required: false, options: [], instruction: '', label: 'Date of test', width: 'half' },

            // ════════ ROAD TEST EVALUATION (scored — pass mark 12 / 15) ════════
            { id: 'f-ats-rt-grp-eval', type: 'heading', required: false, options: [], label: 'Road Test Evaluation', instruction: 'Rate each section out of 5 using the scale above. A minimum total of 12 / 15 is required to pass.' },

            // 1 · Vehicle Systems and Components
            { id: 'f-ats-rt-ev1-head', type: 'heading', required: false, options: [], label: 'Vehicle Systems and Components', instruction: 'Operate commercial vehicle systems and features.' },
            { id: 'f-ats-rt-ev1-items', type: 'checklist', required: false, label: 'Checklist', instruction: '', options: [
                'Locates and operates all typical primary and secondary controls, gauges and instruments.',
                'Reads the instrument panel indicators displaying important vehicle operating information, warnings and safety system status.',
                'Operates one or more typical manual transmission and clutch, automated manual transmission and/or automatic transmission.',
                'Locates fuel tanks and filler caps, and applies proper fueling methods.',
                'Identifies important commercial vehicle service items, and locates operating fluid checkpoints.',
                'Identifies the correct operating fluids required for a vehicle and properly re-fills and maintains fluid levels.',
                'Operates a differential lock or inter-axle differential lock, if equipped.',
                'Operates vehicle heating, defrosting and air-conditioning systems.',
                'Operates vehicle lamps and accessories.',
                'Operates windshield wiper and washer systems.',
                'Carries, secures, stores and uses, or operates required emergency equipment.',
            ] },
            { id: 'f-ats-rt-ev1-score', type: 'number', required: false, options: [], instruction: 'Examiner rating, 1–5.', label: 'Section score (/5)' },

            // 2 · Tractor-Trailer Off-Road Tasks & Manoeuvres
            { id: 'f-ats-rt-ev2-head', type: 'heading', required: false, options: [], label: 'Tractor-Trailer Off-Road Tasks & Manoeuvres', instruction: 'Performs parking and backing manoeuvres with a tractor-trailer.' },
            { id: 'f-ats-rt-ev2-straight', type: 'checklist', required: false, label: 'Straight-Line Backing', instruction: 'Manoeuvre Space — straight-line backing manoeuvres will be in a space that is between 3.5 and 3.7 metres wide and 30 metres long.', options: [
                'Performs straight-line backing manoeuvres with a tractor-trailer unit in a safe manner.',
                '1) Check mirror set up',
                '2) Position the tractor-trailer for the backing manoeuvre',
                '3) Secure the vehicle and activate the warning flashers',
                '4) Exit the vehicle to examine the manoeuvre space and check vehicle position',
                '5) Re-enter the vehicle, open windows and silence audio devices',
                '6) Sound vehicle horn briefly',
                '7) Reverse into the space at idle speed',
                '8) Pull up the vehicle no more than once to align it during the manoeuvre',
                '9) Exit the tractor to examine space and vehicle alignment no more than once during the manoeuvre',
                '10) Complete the reverse movement while staying entirely within the manoeuvre space',
                '11) Stop tractor-trailer movement upon reaching the desired position (stop gently when backing up to a solid fixture)',
                '12) Complete the backing manoeuvre within 10 min.',
            ] },
            { id: 'f-ats-rt-ev2-offset', type: 'checklist', required: false, label: 'Offset Backing', instruction: 'Manoeuvre Space — offset backing manoeuvres will be from a space between 3.5 and 3.7 metres wide and at least as long as the tractor-trailer, into an adjacent space of the same dimensions. The pull-up space in front of the two spaces must be at least one and one-half times the length of the tractor-trailer. The manoeuvre will be learned from both sides.', options: [
                'Performs offset backing manoeuvres with a tractor-trailer in a safe manner.',
                '1) Check mirror set up',
                '2) Drive the tractor-trailer forward out of the starting position',
                '3) Align the tractor-trailer with the target space while driving forward into the pull-up area',
                '4) Secure the vehicle and activate the warning flashers',
                '5) Exit the vehicle to examine the manoeuvre space from outside the vehicle and check vehicle position if necessary',
                '6) Re-enter the vehicle, open windows and silence audio devices',
                '7) Sound vehicle horn briefly',
                '8) Reverse into the space at idle speed',
                '9) Pull up the tractor-trailer no more than twice to align it during the manoeuvre',
                '10) Exit the tractor to examine space and vehicle alignment no more than twice during the manoeuvre',
                '11) Complete the reverse movement while staying entirely within the manoeuvre space',
                '12) Stop tractor-trailer movement upon reaching the desired position',
                '13) Stop the tractor-trailer gently when backing up to a solid fixture',
                '14) Complete the backing manoeuvre within 10 min.',
            ] },
            { id: 'f-ats-rt-ev2-alley', type: 'checklist', required: false, label: 'Alley-Dock Backing', instruction: 'Manoeuvre Space — alley-dock backing manoeuvres will be into a space between 3.5 and 3.7 metres wide and at least 2/3 the length of the tractor-trailer, starting with the vehicle perpendicular to the space and the front of the tractor directly in front of it. The pull-up space must be no deeper than the length of the vehicle. The manoeuvre will be learned from both sides.', options: [
                'Performs alley-dock backing manoeuvres with a tractor-trailer in a safe manner.',
                '1) Check mirror set up',
                '2) Drive the vehicle forward out of the starting position',
                '3) Align the trailer with the target space while driving forward into the pull-up area',
                '4) Secure the vehicle and activate the warning flashers',
                '5) Exit the vehicle to examine the manoeuvre space from outside the vehicle and check vehicle position if necessary',
                '6) Re-enter the vehicle, open windows and silence audio devices',
                '7) Sound vehicle horn briefly',
                '8) Reverse into the space at idle speed',
                '9) Pull up the vehicle no more than twice to align it during the manoeuvre',
                '10) Exit the vehicle to examine space and vehicle alignment no more than twice during the manoeuvre',
                '11) Complete the reverse movement while staying entirely within the manoeuvre space',
                '12) Stop vehicle movement upon reaching the desired position',
                '13) Stop the vehicle gently when backing up to a solid fixture',
                '14) Complete the backing manoeuvre within 10 min.',
            ] },
            { id: 'f-ats-rt-ev2-score', type: 'number', required: false, options: [], instruction: 'Examiner rating, 1–5.', label: 'Section score (/5)' },

            // 3 · Coupling and Uncoupling
            { id: 'f-ats-rt-ev3-head', type: 'heading', required: false, options: [], label: 'Coupling and Uncoupling', instruction: 'Couple / uncouple trailers.' },
            { id: 'f-ats-rt-ev3-couple', type: 'checklist', required: false, label: 'Coupling Trailer', instruction: 'Couples a tractor-trailer unit in a safe manner.', options: [
                '1) Start the coupling task:',
                'a) Inspect lower couplers and connectors while outside the vehicle',
                'b) Enter the vehicle and begin reversing slowly; approach the trailer with the tractor as straight in line as possible; overcome any challenges involving ground surface conditions',
                '2) Continue coupling with a tractor with fixed suspension:',
                'a) Align the tractor and trailer, reversing until the fifth wheel is just ahead of the trailer, touching or slightly under, but not against the kingpin',
                'b) Exit the tractor and check the upper coupler; confirm the kingpin is aligned (no more than 10 cm / 4 in from the centre of the fifth wheel lower coupler); adjust height if necessary',
                'c) Re-enter the vehicle and continue reversing toward the trailer; monitor the trailer’s position using the mirrors to confirm proper alignment',
                'd) Reverse the tractor and gently but firmly engage the fifth wheel',
                'e) Listen for and feel the fifth wheel latch into its locked position',
                '3) Continue coupling with a tractor having air suspension with a suspension-drop feature:',
                'a) Reverse the vehicle slowly toward the trailer until the fifth wheel just touches it, or is about to touch it',
                'b) Exit the tractor and check vehicle heights',
                'c) Re-enter the tractor and release (dump) the air suspension; reverse until the fifth wheel lower coupler is fully under the front of the trailer, but still ahead of the kingpin',
                'd) Restore the tractor air suspension to its normal height',
                'e) Monitor the trailer’s position using the mirrors to confirm proper alignment',
                'f) Reverse the tractor and gently but firmly engage the fifth wheel',
                'g) Listen for and feel the fifth wheel latch into its locked position',
                '4) Complete the coupling for all suspension types:',
                'a) Attempt to move the tractor forward — perform a tug test',
                'b) Exit the vehicle and visually confirm the fifth wheel is locked',
                'c) Check fifth wheel contact',
                'd) Check release handle position and latch',
                'e) Connect air and electrical lines properly',
                'f) Confirm normal air / electrical operation',
                'g) Raise the trailer landing gear fully',
                'h) Stow the landing gear handle into its retainer',
                'i) Re-enter the vehicle and supply air to the trailer with the trailer supply valve',
                'j) Monitor air pressure gauges and confirm normal pressure levels',
                'k) Drive forward slowly a short distance and apply the trailer / full service brakes to test brake operation',
            ] },
            { id: 'f-ats-rt-ev3-uncouple', type: 'checklist', required: false, label: 'Uncoupling Trailer', instruction: 'Uncouples a tractor-trailer in a safe manner.', options: [
                '1) Start the uncoupling task:',
                'a) Confirm the location is suitable and safe for uncoupling',
                'b) Park the trailer in the selected location and apply the trailer parking brakes',
                'c) Secure and exit the tractor',
                'd) Place required wheel chocks and blocks, or engage locks into position',
                'e) Place adequate support material under the landing gear if necessary',
                'f) Operate trailer air suspension controls as required',
                'g) Lower the landing gear until it is just above or just touches the ground (do not raise the trailer from the fifth wheel)',
                'h) Leave the landing gear handle in low range and stow the handle',
                'i) Disconnect air and electrical connections and stow them',
                'j) Release the fifth wheel coupler lock',
                '2) Uncoupling with fixed suspension:',
                'a) Re-enter the vehicle and drive forward slowly to release the fifth wheel',
                'b) Watch the trailer in the mirrors or out the rear window and confirm it is stable',
                'c) When the fifth wheel lower coupler is fully out from under the trailer, stop while the tractor is still under the front of the trailer',
                'd) Exit the tractor and check the trailer is stable and secure, then drive forward slowly until the tractor is clear',
                '3) Uncoupling with air suspension (drop feature):',
                'a) Re-enter the vehicle and drive forward slowly far enough to unlatch the fifth wheel coupler, then stop',
                'b) Operate the control to drop the tractor suspension',
                'c) Watch the trailer in the mirrors or out the rear window and confirm it is stable',
                'd) When the fifth wheel lower coupler is fully out from under the trailer, stop while the tractor is still under the front of the trailer',
                'e) Exit the vehicle and check the trailer is stable and secure, then drive forward slowly until the tractor is clear; raise the tractor suspension to normal position',
            ] },
            { id: 'f-ats-rt-ev3-score', type: 'number', required: false, options: [], instruction: 'Examiner rating, 1–5.', label: 'Section score (/5)' },
            ...
            // ── Part 7 ──
            { id: 'f-ats-rt-p7-head', type: 'heading', required: false, options: [], label: 'Part 7 — Miscellaneous', instruction: '' },
            { id: 'f-ats-rt-p7a', type: 'checklist', required: false, label: 'A. General Driving Ability and Habits', instruction: '', options: [
            ...
            { id: 'f-ats-rt-p7b', type: 'textarea', required: false, options: [], instruction: 'Specify any special equipment used during the test.', label: 'B. Use of Special Equipment (specify)' },

            // ── Result ──
            { id: 'f-ats-rt-remarks', type: 'textarea', required: false, options: [], instruction: '', label: 'Remarks' },
            { id: 'f-ats-rt-performance', type: 'radio', required: false, options: ['Satisfactory', 'Needs Training'], instruction: '', label: 'General performance' },
            { id: 'f-ats-rt-explain', type: 'text', required: false, options: [], instruction: '', label: 'Explain (if needs training)' },
            ...
            { id: 'f-ats-rt-special-equip', type: 'text', required: false, options: [], instruction: '', label: 'Special equipment (specify)' },
