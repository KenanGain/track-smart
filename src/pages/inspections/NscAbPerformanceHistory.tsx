...
// ─── Carry Freight Ltd. (NSC AB243-8992) — 2019-09-30 pull
// Source: docs/alberta-extraction-vendor-package-v7/per-pdf/Carrier_Profile_30_Sept_2019/extracted.json
// 13 convictions across 4 CCMTA groups (Speeding, Driving, Hours of Service, Trip Inspections).
const AB_CONV_GROUPS: AbConvictionGroupRow[] = [
  { group:'Speeding',                                                     count:1, pct:'7.7%'   },
  { group:'Stop signs/Traffic lights',                                    count:0, pct:''       },
  { group:'Driver Liabilities (Licence, Insurance, Seat Belts, etc.)',    count:0, pct:''       },
  { group:'Driving (Passing, Disobey Signs, Signals, etc.)',              count:4, pct:'30.8%'  },
  { group:'Hours of Service',                                             count:6, pct:'46.1%'  },
  { group:'Trip Inspections',                                             count:2, pct:'15.4%'  },
...
const AB_CONV_TOTAL = { count: 13, pct: '100%' };

const AB_CONV_SUMMARY: AbConvictionSummaryRow[] = [
  { seq: 1, date:'2019 JUN 20', document:'OPC MB15102272',    docket:'15102272',    jur:'MB', vehicle:'U11095 AB', driverName:'INDERPAL SINGH GREWAL',      offence:'LOG NOT UP TO DATE',        pts:2 },
  { seq: 2, date:'2018 NOV 21', document:'OPC ON96109798',    docket:'96109798',    jur:'ON', vehicle:'E75062 AB', driverName:'MIAN NISAR AHMED',           offence:'NO TRIP INSPECTION',        pts:1 },
  { seq: 3, date:'2018 NOV 21', document:'OPC ON96109799',    docket:'96109799',    jur:'ON', vehicle:'E75062 AB', driverName:'GURDEV KALEAR',              offence:'NO TRIP INSPECTION',        pts:1 },
  { seq: 4, date:'2018 NOV 14', document:'OPC ON96306606',    docket:'96306606',    jur:'ON', vehicle:'U00291 AB', driverName:'Kathivavelu Kirupakaran',    offence:'DRIVING CONTRARY TO SIGN',  pts:2 },
  { seq: 5, date:'2018 JUL 28', document:'OPC ON86937174',    docket:'86937174',    jur:'ON', vehicle:'E65208 AB', driverName:'AMRINDER SINGH GILL',        offence:'TWO LOGS OR FALSE LOGS',    pts:3 },
  { seq: 6, date:'2018 JUL 19', document:'OPC BCAJ060378751', docket:'AJ060378751', jur:'BC', vehicle:'E65208 AB', driverName:'Amrinder Singh Gill',        offence:'DRIVE WITHOUT DUE CARE',    pts:0 },
  { seq: 7, date:'2018 JUL 18', document:'OPC ON96080455',    docket:'96080455',    jur:'ON', vehicle:'E75062 AB', driverName:'MIAN NISAR AHMED',           offence:'DRIVING CONTRARY TO SIGN',  pts:2 },
  { seq: 8, date:'2018 JUN 10', document:'OPC ON96622956',    docket:'96622956',    jur:'ON', vehicle:'E65166 AB', driverName:'. Navdeep Singh',            offence:'DRIVE WITHOUT DUE CARE',    pts:3 },
  { seq: 9, date:'2018 JUN 10', document:'OPC ON96622957',    docket:'96622957',    jur:'ON', vehicle:'E65166 AB', driverName:'. Navdeep Singh',            offence:'EXCEED POSTED SPEED LIMIT', pts:1 },
  { seq:10, date:'2018 JUN 10', document:'OPC ON96622958',    docket:'96622958',    jur:'ON', vehicle:'E65166 AB', driverName:'',                            offence:'FAIL TO KEEP LOGS/DOCS',    pts:3 },
  { seq:11, date:'2018 JUN 10', document:'OPC ON96622961',    docket:'96622961',    jur:'ON', vehicle:'E65166 AB', driverName:'',                            offence:'TWO LOGS OR FALSE LOGS',    pts:3 },
  { seq:12, date:'2018 JUN 10', document:'OPC ON96622962',    docket:'96622962',    jur:'ON', vehicle:'E65166 AB', driverName:'',                            offence:'EXCEEDING HRS ON DUTY',     pts:3 },
  { seq:13, date:'2018 JUN 05', document:'OPC ON96002105',    docket:'96002105',    jur:'ON', vehicle:'E65208 AB', driverName:'Amrinder Singh Gill',        offence:'LOG NOT UP TO DATE',        pts:2 },
];

const AB_CONV_DETAILS: AbConvictionDetailRow[] = [
  { seq: 1, date:'2019 JUN 20', time:'00:00', document:'OPC MB15102272',    docket:'15102272',    jurisdiction:'Manitoba',         dateEntered:'2019 SEP 10', issuingAgency:'', location:'HEADINGLEY (RM)',     driver:'INDERPAL SINGH GREWAL G73663628590530 ON',     vehicle:'U11095 AB', commodity:'', actSection:'', actDesc:'LOG NOT UP TO DATE',        ccmtaCode:'0401 LOG NOT UP TO DATE',        convVehicle:'U11095 AB', convDate:'2019 AUG 28', activePts:2 },
  { seq: 2, date:'2018 NOV 21', time:'11:50', document:'OPC ON96109798',    docket:'96109798',    jurisdiction:'Ontario',          dateEntered:'2019 APR 30', issuingAgency:'', location:'HWY 11, OBRIEN TWP', driver:'MIAN NISAR AHMED M500620055600 QC',            vehicle:'E75062 AB', commodity:'', actSection:'', actDesc:'NO TRIP INSPECTION',        ccmtaCode:'0502 NO TRIP INSPECTION',        convVehicle:'E75062 AB', convDate:'2019 APR 11', activePts:1 },
  { seq: 3, date:'2018 NOV 21', time:'11:50', document:'OPC ON96109799',    docket:'96109799',    jurisdiction:'Ontario',          dateEntered:'2019 APR 30', issuingAgency:'', location:'HWY 11, OBRIEN TWP', driver:'GURDEV KALEAR K460414075204 QC',               vehicle:'E75062 AB', commodity:'', actSection:'', actDesc:'NO TRIP INSPECTION',        ccmtaCode:'0502 NO TRIP INSPECTION',        convVehicle:'E75062 AB', convDate:'2019 APR 11', activePts:1 },
  { seq: 4, date:'2018 NOV 14', time:'09:31', document:'OPC ON96306606',    docket:'96306606',    jurisdiction:'Ontario',          dateEntered:'2019 JUN 18', issuingAgency:'', location:'HWY 17, COYLE TWP',  driver:'Kathivavelu Kirupakaran 8562311 BC',           vehicle:'U00291 AB', commodity:'', actSection:'', actDesc:'DRIVING CONTRARY TO SIGN',  ccmtaCode:'0330 DRIVING CONTRARY TO SIGN',  convVehicle:'U00291 AB', convDate:'2019 JUN 05', activePts:2 },
  { seq: 5, date:'2018 JUL 28', time:'08:18', document:'OPC ON86937174',    docket:'86937174',    jurisdiction:'Ontario',          dateEntered:'2018 DEC 04', issuingAgency:'', location:'HWY 17, THUNDER BAY',driver:'AMRINDER SINGH GILL G43500408841006 ON',       vehicle:'E65208 AB', commodity:'', actSection:'', actDesc:'TWO LOGS OR FALSE LOGS',    ccmtaCode:'0402 TWO LOGS OR FALSE LOGS',    convVehicle:'E65208 AB', convDate:'2018 NOV 20', activePts:3 },
  { seq: 6, date:'2018 JUL 19', time:'00:00', document:'OPC BCAJ060378751', docket:'AJ060378751', jurisdiction:'British Columbia', dateEntered:'2018 NOV 06', issuingAgency:'', location:'BURNABY',             driver:'Amrinder Singh Gill G43500408841006 ON',       vehicle:'E65208 AB', commodity:'', actSection:'', actDesc:'DRIVE WITHOUT DUE CARE',    ccmtaCode:'0016 DRIVE WITHOUT DUE CARE',    convVehicle:'E65208 AB', convDate:'2018 AUG 19', activePts:0 },
  { seq: 7, date:'2018 JUL 18', time:'08:00', document:'OPC ON96080455',    docket:'96080455',    jurisdiction:'Ontario',          dateEntered:'2019 APR 16', issuingAgency:'', location:'HWY 11, JESSIE LAKE',driver:'MIAN NISAR AHMED M500620055600 QC',            vehicle:'E75062 AB', commodity:'', actSection:'', actDesc:'DRIVING CONTRARY TO SIGN',  ccmtaCode:'0330 DRIVING CONTRARY TO SIGN',  convVehicle:'E75062 AB', convDate:'2019 APR 04', activePts:2 },
  { seq: 8, date:'2018 JUN 10', time:'10:45', document:'OPC ON96622956',    docket:'96622956',    jurisdiction:'Ontario',          dateEntered:'2019 SEP 24', issuingAgency:'', location:'HWY 17A, KENORA',    driver:'. Navdeep Singh 169728-110 AB',                vehicle:'E65166 AB', commodity:'', actSection:'', actDesc:'DRIVE WITHOUT DUE CARE',    ccmtaCode:'0016 DRIVE WITHOUT DUE CARE',    convVehicle:'E65166 AB', convDate:'2019 SEP 05', activePts:3 },
  { seq: 9, date:'2018 JUN 10', time:'11:00', document:'OPC ON96622957',    docket:'96622957',    jurisdiction:'Ontario',          dateEntered:'2019 SEP 24', issuingAgency:'', location:'HWY 17, UNORG',      driver:'. Navdeep Singh 169728-110 AB',                vehicle:'E65166 AB', commodity:'', actSection:'', actDesc:'EXCEED POSTED SPEED LIMIT', ccmtaCode:'0004 EXCEED POSTED SPEED LIMIT', convVehicle:'E65166 AB', convDate:'2019 SEP 05', activePts:1 },
  { seq:10, date:'2018 JUN 10', time:'11:05', document:'OPC ON96622958',    docket:'96622958',    jurisdiction:'Ontario',          dateEntered:'2019 SEP 17', issuingAgency:'', location:'@ABHWY 17 BOYS TWP', driver:'',                                              vehicle:'E65166 AB', commodity:'', actSection:'', actDesc:'FAIL TO KEEP LOGS/DOCS',    ccmtaCode:'0405 FAIL TO KEEP LOGS/DOCS',    convVehicle:'E65166 AB', convDate:'2019 SEP 05', activePts:3 },
  { seq:11, date:'2018 JUN 10', time:'11:05', document:'OPC ON96622961',    docket:'96622961',    jurisdiction:'Ontario',          dateEntered:'2019 SEP 17', issuingAgency:'', location:'@ABHWY 17 BOYS TWP', driver:'',                                              vehicle:'E65166 AB', commodity:'', actSection:'', actDesc:'TWO LOGS OR FALSE LOGS',    ccmtaCode:'0402 TWO LOGS OR FALSE LOGS',    convVehicle:'E65166 AB', convDate:'2019 SEP 05', activePts:3 },
  { seq:12, date:'2018 JUN 10', time:'11:05', document:'OPC ON96622962',    docket:'96622962',    jurisdiction:'Ontario',          dateEntered:'2019 SEP 17', issuingAgency:'', location:'@ABHWY 17 BOYS TWP', driver:'',                                              vehicle:'E65166 AB', commodity:'', actSection:'', actDesc:'EXCEEDING HRS ON DUTY',     ccmtaCode:'0400 EXCEEDING HRS ON DUTY',     convVehicle:'E65166 AB', convDate:'2019 SEP 05', activePts:3 },
  { seq:13, date:'2018 JUN 05', time:'08:50', document:'OPC ON96002105',    docket:'96002105',    jurisdiction:'Ontario',          dateEntered:'2019 MAR 26', issuingAgency:'', location:'COCHRANE TIS',       driver:'Amrinder Singh Gill G43500408841006 ON',       vehicle:'E65208 AB', commodity:'', actSection:'', actDesc:'LOG NOT UP TO DATE',        ccmtaCode:'0401 LOG NOT UP TO DATE',        convVehicle:'E65208 AB', convDate:'2019 MAR 14', activePts:2 },
];
...
// Sept-2019 pull printed 20 defect categories (the form added category 20 that
// year). Cat 9 wording is "(Part II Section 9 only)" in this revision.
const AB_CVSA_DEFECTS: AbCvsaDefectRow[] = [
  { code:'1',  label:'Driver Credentials',                                oos:2, req:5,  total:7,  pct:'17.9%' },
  { code:'2',  label:'Hours Of Service',                                  oos:3, req:3,  total:6,  pct:'15.4%' },
  { code:'3',  label:'Brake Adjustment',                                  oos:1,         total:1,  pct:'2.6%'  },
  { code:'4',  label:'Brake Systems',                                            req:10, total:10, pct:'25.7%' },
  { code:'5',  label:'Coupling Devices' },
  { code:'6',  label:'Exhaust Systems' },
  { code:'7',  label:'Frames' },
  { code:'8',  label:'Fuel Systems' },
  { code:'9',  label:'Lighting Devices (Part II Section 9 only)',         oos:1, req:7,  total:8,  pct:'20.5%' },
  { code:'10', label:'Cargo Securement' },
  { code:'11', label:'Steering Mechanisms' },
  { code:'12', label:'Suspensions' },
  { code:'13', label:'Tires',                                             oos:1, req:1,  total:2,  pct:'5.1%'  },
  { code:'14', label:'Van/Open-top Trailer Bodies' },
  { code:'15', label:'Wheels, Rims & Hubs',                               oos:1,         total:1,  pct:'2.6%'  },
  { code:'16', label:'Windshield Wipers',                                        req:2,  total:2,  pct:'5.1%'  },
  { code:'17', label:'Emergency Exits/Wiring & Electrical Systems (Buses)' },
  { code:'18', label:'Dangerous Goods',                                   oos:1, req:1,  total:2,  pct:'5.1%'  },
  { code:'19', label:'Driveline/Driveshaft' },
  { code:'20', label:"Driver's Seat (Missing)" },
];
const AB_CVSA_DEFECT_TOTAL = { oos:10, req:29, total:39, pct:'100%' };

const AB_CVSA_SUMMARY: AbCvsaSummaryRow[] = [
  { seq: 1, date:'2019 SEP 12', document:'OPI 8776286',          jur:'BC', agency:'',     plate:'U11096', plateJur:'AB', level:2, result:'Out of Service' },
  { seq: 2, date:'2019 AUG 22', document:'OPI ONEA01338404',     jur:'ON', agency:'',     plate:'E75062', plateJur:'AB', level:2, result:'Passed' },
  { seq: 3, date:'2019 AUG 21', document:'CVR AB194748EI',       jur:'AB', agency:'GADU', plate:'U11096', plateJur:'AB', level:2, result:'Out of Service' },
  { seq: 4, date:'2019 AUG 20', document:'OPI 8756916',          jur:'BC', agency:'',     plate:'E75062', plateJur:'AB', level:1, result:'Requires Attention' },
  { seq: 5, date:'2019 AUG 16', document:'OPI ONEA01338072',     jur:'ON', agency:'',     plate:'U11099', plateJur:'AB', level:2, result:'Passed' },
  { seq: 6, date:'2019 JUL 08', document:'OPI 8724716',          jur:'BC', agency:'',     plate:'M1767S', plateJur:'ON', level:1, result:'Requires Attention' },
  { seq: 7, date:'2019 JUN 20', document:'OPI MBE19-9500-03323', jur:'MB', agency:'',     plate:'U11095', plateJur:'AB', level:2, result:'Requires Attention' },
  { seq: 8, date:'2019 JUN 18', document:'OPI MBE19-1400-02436', jur:'MB', agency:'',     plate:'E65208', plateJur:'AB', level:3, result:'Out of Service' },
  { seq: 9, date:'2019 JUN 05', document:'OPI 8702696',          jur:'BC', agency:'',     plate:'U23906', plateJur:'AB', level:1, result:'Requires Attention' },
  { seq:10, date:'2019 MAY 02', document:'OPI ONEA01307275',     jur:'ON', agency:'',     plate:'E59949', plateJur:'AB', level:2, result:'Out of Service' },
  { seq:11, date:'2019 FEB 20', document:'OPI ONEA01291043',     jur:'ON', agency:'',     plate:'E65166', plateJur:'AB', level:2, result:'Out of Service' },
  { seq:12, date:'2019 FEB 20', document:'OPI 8658251',          jur:'BC', agency:'',     plate:'E77384', plateJur:'AB', level:1, result:'Requires Attention' },
  { seq:13, date:'2019 FEB 05', document:'OPI 8654027',          jur:'BC', agency:'',     plate:'U00291', plateJur:'AB', level:2, result:'Out of Service' },
  { seq:14, date:'2019 JAN 30', document:'OPI ONEA01275999',     jur:'ON', agency:'',     plate:'E59949', plateJur:'AB', level:3, result:'Passed' },
  { seq:15, date:'2018 DEC 13', document:'OPI ONEA01272231',     jur:'ON', agency:'',     plate:'E75062', plateJur:'AB', level:3, result:'Passed' },
  { seq:16, date:'2018 DEC 12', document:'OPI ONEA01273068',     jur:'ON', agency:'',     plate:'U04031', plateJur:'AB', level:2, result:'Out of Service' },
  { seq:17, date:'2018 NOV 27', document:'OPI ONEA01263997',     jur:'ON', agency:'',     plate:'U04031', plateJur:'AB', level:2, result:'Out of Service' },
  { seq:18, date:'2018 NOV 10', document:'OPI 8628393',          jur:'BC', agency:'',     plate:'N3759S', plateJur:'ON', level:2, result:'Out of Service' },
  { seq:19, date:'2018 OCT 17', document:'OPI ONEA01251954',     jur:'ON', agency:'',     plate:'E77384', plateJur:'AB', level:2, result:'Passed' },
  { seq:20, date:'2018 SEP 25', document:'OPI ONEA01249644',     jur:'ON', agency:'',     plate:'E80652', plateJur:'AB', level:2, result:'Passed' },
  { seq:21, date:'2018 AUG 16', document:'OPI ONEA01237362',     jur:'ON', agency:'',     plate:'E75062', plateJur:'AB', level:2, result:'Passed' },
  { seq:22, date:'2018 AUG 16', document:'OPI 8605275',          jur:'BC', agency:'',     plate:'E80652', plateJur:'AB', level:1, result:'Out of Service' },
  { seq:23, date:'2018 JUN 13', document:'OPI ONEA01215795',     jur:'ON', agency:'',     plate:'E65114', plateJur:'AB', level:2, result:'Passed' },
  { seq:24, date:'2018 JUN 05', document:'OPI ONEA01219694',     jur:'ON', agency:'',     plate:'E65208', plateJur:'AB', level:1, result:'Requires Attention' },
  { seq:25, date:'2018 JUN 01', document:'OPI ONEA01211359',     jur:'ON', agency:'',     plate:'E65114', plateJur:'AB', level:2, result:'Requires Attention' },
];

const AB_CVSA_DETAILS: AbCvsaDetailRow[] = [
  { seq: 1, date:'2019 SEP 12', time:'15:35', document:'OPI 8776286',          jur:'BC', level:2, result:'Out of Service',     dateEntered:'2019 SEP 17', agency:'',                                              location:'KAMLOOPS',           driver:'Jagseer singh BATTH BA-TT-HJ-S114QK MB',
    vehicles:[ { type:'P',  plate:'U11096', jur:'AB', vin:'4V4NC9EH7GN928471', year:'2016', make:'Volvo' }, { type:'ST', plate:'5LX714', jur:'AB', make:'MANAC' } ],
    defects:[ { cat:'13 - Tires', vehicle:2, kind:'OOS' }, { cat:'9 - Lighting Devices (Part II Section 9 only)', vehicle:2, kind:'REQ' } ] },
  { seq: 2, date:'2019 AUG 22', time:'07:25', document:'OPI ONEA01338404',     jur:'ON', level:2, result:'Passed',             dateEntered:'2019 SEP 03', agency:'',                                              location:'WASSI SOUTH TIS',    driver:'MIAN NISAR AHMED M500620055600 QC',
    vehicles:[ { type:'P',  plate:'E75062', jur:'AB', vin:'4V4NC9EH6DN133195', year:'2013', make:'Volvo' }, { type:'ST', plate:'S6294E', jur:'ON', make:'UTIL' } ], defects:[] },
  { seq: 3, date:'2019 AUG 21', time:'15:48', document:'CVR AB194748EI',       jur:'AB', level:2, result:'Out of Service',     dateEntered:'2019 AUG 31', agency:'GOVERNMENT ALBERTA - COMM VEH ENF - DUNMORE',    location:'Dunmore - VIS',      driver:'Jagseer singh BATTH BA-TT-HJ-S114QK MB',
    vehicles:[ { type:'P',  plate:'U11096', jur:'AB', vin:'4V4NC9EH7GN928471', year:'2016', make:'Volvo' }, { type:'ST', plate:'R8066J', jur:'ON', vin:'1UYVS2532K7526219', year:'2016', make:'Utility' } ],
    defects:[ { cat:'15 - Wheels, Rims & Hubs', vehicle:2, kind:'OOS' }, { cat:'4 - Brake Systems', vehicle:2, kind:'REQ' } ] },
  { seq: 4, date:'2019 AUG 20', time:'10:23', document:'OPI 8756916',          jur:'BC', level:1, result:'Requires Attention', dateEntered:'2019 AUG 27', agency:'',                                              location:'GOLDEN',             driver:'GURDEV KALEAR K4604-140752-04 QC',
    vehicles:[ { type:'P',  plate:'E75062', jur:'AB', vin:'4V4NC9EH6DN133195', year:'2013', make:'Volvo' }, { type:'ST', plate:'S6294E', jur:'ON', make:'UTIL' } ],
    defects:[ { cat:'4 - Brake Systems', vehicle:1, kind:'REQ' }, { cat:'4 - Brake Systems', vehicle:2, kind:'REQ' }, { cat:'16 - Windshield Wipers', vehicle:1, kind:'REQ' } ] },
  { seq: 5, date:'2019 AUG 16', time:'10:30', document:'OPI ONEA01338072',     jur:'ON', level:2, result:'Passed',             dateEntered:'2019 AUG 27', agency:'',                                              location:'HEYDEN TIS',         driver:'Rajinderpal Singh Sandhu 151111-747 AB',
    vehicles:[ { type:'P',  plate:'U11099', jur:'AB', vin:'4V4NC9EH7FN189505', year:'2015', make:'Volvo' }, { type:'ST', plate:'R8061J', jur:'ON', make:'UTIL' } ], defects:[] },
  { seq: 6, date:'2019 JUL 08', time:'09:10', document:'OPI 8724716',          jur:'BC', level:1, result:'Requires Attention', dateEntered:'2019 JUL 16', agency:'',                                              location:'HUNTER CREEK',       driver:'Amrinder Singh Gill G43500408841006 ON',
    vehicles:[ { type:'ST', plate:'M1767S', jur:'ON', make:'UTILITY' }, { type:'P',  plate:'E65208', jur:'AB', vin:'1XPXD49X1JD467897', year:'2018', make:'Peterbilt' } ],
    defects:[ { cat:'1 - Driver Credentials', vehicle:2, kind:'REQ' }, { cat:'4 - Brake Systems', vehicle:2, kind:'REQ' }, { cat:'9 - Lighting Devices (Part II Section 9 only)', vehicle:2, kind:'REQ' } ] },
  { seq: 7, date:'2019 JUN 20', time:'12:17', document:'OPI MBE19-9500-03323', jur:'MB', level:2, result:'Requires Attention', dateEntered:'2019 JUN 25', agency:'',                                              location:'001',                driver:'INDERPAL SINGH GREWAL G73663628590530 ON',
    vehicles:[ { type:'P',  plate:'U11095', jur:'AB', vin:'1FUJHHDRXLLKW7596', year:'2020', make:'Freightliner' }, { type:'ST', plate:'M1695S', jur:'ON', make:'UTILITY' } ],
    defects:[ { cat:'2 - Hours Of Service', vehicle:1, kind:'REQ' }, { cat:'2 - Hours Of Service', vehicle:2, kind:'REQ' } ] },
  { seq: 8, date:'2019 JUN 18', time:'14:31', document:'OPI MBE19-1400-02436', jur:'MB', level:3, result:'Out of Service',     dateEntered:'2019 JUL 02', agency:'',                                              location:'PTH 16 AT MINNEDOSA',driver:'Amrinder Singh Gill G43500408841006 ON',
    vehicles:[ { type:'P',  plate:'E65208', jur:'AB', vin:'1XPXD49X1JD467897', year:'2018', make:'Peterbilt' }, { type:'ST', plate:'R8066J', jur:'ON', make:'UTILITY' } ],
    defects:[ { cat:'2 - Hours Of Service', vehicle:1, kind:'OOS' } ] },
  { seq: 9, date:'2019 JUN 05', time:'20:45', document:'OPI 8702696',          jur:'BC', level:1, result:'Requires Attention', dateEntered:'2019 JUN 11', agency:'',                                              location:'HOPE',               driver:'Gagandeep Singh Gill 166312-454 AB',
    vehicles:[ { type:'P',  plate:'U23906', jur:'AB', vin:'1FUJA6CK56PW37718', year:'2006', make:'Freightliner' }, { type:'ST', plate:'S4831K', jur:'ON', make:'MANA' } ],
    defects:[ { cat:'4 - Brake Systems', vehicle:1, kind:'REQ' }, { cat:'4 - Brake Systems', vehicle:2, kind:'REQ' }, { cat:'9 - Lighting Devices (Part II Section 9 only)', vehicle:1, kind:'REQ' } ] },
  { seq:10, date:'2019 MAY 02', time:'10:20', document:'OPI ONEA01307275',     jur:'ON', level:2, result:'Out of Service',     dateEntered:'2019 MAY 14', agency:'',                                              location:'',                   driver:'SHAHID MUHAMMAD M530801038601 QC',
    vehicles:[ { type:'P',  plate:'E59949', jur:'AB', vin:'4V4NC9EJ6CN546168', year:'2012', make:'Volvo' }, { type:'ST', plate:'R6393B', jur:'ON', make:'UTIL' } ],
    defects:[ { cat:'18 - Dangerous Goods', vehicle:2, kind:'OOS' } ] },
  { seq:11, date:'2019 FEB 20', time:'09:56', document:'OPI ONEA01291043',     jur:'ON', level:2, result:'Out of Service',     dateEntered:'2019 FEB 26', agency:'',                                              location:'HEYDEN TIS',         driver:'THIRUCHENTHURAN NAGARAJAH N01327400780731 ON',
    vehicles:[ { type:'P',  plate:'E65166', jur:'AB', vin:'4V4NC9EH2GN928118', year:'2016', make:'Volvo' }, { type:'ST', plate:'P8488A', jur:'ON', make:'MANA' } ],
    defects:[ { cat:'2 - Hours Of Service', vehicle:1, kind:'OOS' } ] },
  { seq:12, date:'2019 FEB 20', time:'14:28', document:'OPI 8658251',          jur:'BC', level:1, result:'Requires Attention', dateEntered:'2019 APR 16', agency:'',                                              location:'KAMLOOPS',           driver:'SIVALOGANATHAN NADESU 6550853 BC',
    vehicles:[ { type:'P',  plate:'E77384', jur:'AB', vin:'4V4NC9EH4GN929559', year:'2016', make:'Volvo' }, { type:'ST', plate:'R8796V', jur:'ON', make:'UTILITY' } ],
    defects:[ { cat:'1 - Driver Credentials', vehicle:1, kind:'REQ' }, { cat:'4 - Brake Systems', vehicle:1, kind:'REQ' }, { cat:'4 - Brake Systems', vehicle:2, kind:'REQ' }, { cat:'9 - Lighting Devices (Part II Section 8 OOSC only)', vehicle:1, kind:'REQ' } ] },
  { seq:13, date:'2019 FEB 05', time:'16:30', document:'OPI 8654027',          jur:'BC', level:2, result:'Out of Service',     dateEntered:'2019 FEB 12', agency:'',                                              location:'KAMLOOPS',           driver:'PARAMVIR SINGH SI-NG-HP-117P8 MB',
    vehicles:[ { type:'P',  plate:'U00291', jur:'AB', vin:'4V4NC9EH6HN951340', year:'2017', make:'Volvo' }, { type:'ST', plate:'R2536X', jur:'ON', make:'HYTR' } ],
    defects:[ { cat:'1 - Driver Credentials', vehicle:1, kind:'OOS' }, { cat:'9 - Lighting Devices (Part II Section 8 OOSC only)', vehicle:1, kind:'REQ' }, { cat:'9 - Lighting Devices (Part II Section 8 OOSC only)', vehicle:2, kind:'REQ' }, { cat:'16 - Windshield Wipers', vehicle:1, kind:'REQ' } ] },
  { seq:14, date:'2019 JAN 30', time:'21:18', document:'OPI ONEA01275999',     jur:'ON', level:3, result:'Passed',             dateEntered:'2019 FEB 12', agency:'',                                              location:'VERMILLION BAY TIS', driver:'SHUBHAM KAPOOR KAPOOS*045W1 MB',
    vehicles:[ { type:'P',  plate:'E59949', jur:'AB', vin:'4V4NC9EJ6CN546168', year:'2012', make:'Volvo' }, { type:'ST', plate:'TB9581', jur:'MB', make:'VANG' } ], defects:[] },
  { seq:15, date:'2018 DEC 13', time:'01:33', document:'OPI ONEA01272231',     jur:'ON', level:3, result:'Passed',             dateEntered:'2018 DEC 25', agency:'',                                              location:'KINGSTON DISTRICT',  driver:'MIAN NISAR AHMED M500620055600 QC',
    vehicles:[ { type:'P',  plate:'E75062', jur:'AB', vin:'4V4NC9EH6DN133195', year:'2013', make:'Volvo' }, { type:'ST', plate:'R8067J', jur:'ON', make:'UTIL' } ], defects:[] },
  { seq:16, date:'2018 DEC 12', time:'19:25', document:'OPI ONEA01273068',     jur:'ON', level:2, result:'Out of Service',     dateEntered:'2018 DEC 18', agency:'',                                              location:'HEYDEN TIS',         driver:'Gursharan Singh Grewal G73663088800917 ON',
    vehicles:[ { type:'P',  plate:'U04031', jur:'AB', vin:'4V4NC9EH9GN928469', year:'2016', make:'Volvo' }, { type:'ST', plate:'N9446R', jur:'ON', make:'CIMC' } ],
    defects:[ { cat:'9 - Lighting Devices (Part II Section 8 OOSC only)', vehicle:2, kind:'OOS' } ] },
  { seq:17, date:'2018 NOV 27', time:'13:11', document:'OPI ONEA01263997',     jur:'ON', level:2, result:'Out of Service',     dateEntered:'2018 DEC 04', agency:'',                                              location:'HEYDEN TIS',         driver:'Gursharan Singh Grewal G73663088800917 ON',
    vehicles:[ { type:'P',  plate:'U04031', jur:'AB', vin:'4V4NC9EH9GN928469', year:'2016', make:'Volvo' }, { type:'ST', plate:'M5787W', jur:'ON', make:'VANG' } ],
    defects:[ { cat:'2 - Hours Of Service', vehicle:2, kind:'OOS' }, { cat:'1 - Driver Credentials', vehicle:1, kind:'REQ' }, { cat:'18 - Dangerous Goods', vehicle:2, kind:'REQ' } ] },
  { seq:18, date:'2018 NOV 10', time:'13:11', document:'OPI 8628393',          jur:'BC', level:2, result:'Out of Service',     dateEntered:'2018 NOV 13', agency:'',                                              location:'KAMLOOPS',           driver:'SIVALOGANATHAN NADESU 6550853 BC',
    vehicles:[ { type:'ST', plate:'N3759S', jur:'ON', make:'UTIL' }, { type:'P',  plate:'E77384', jur:'AB', vin:'4V4NC9EH4GN929559', year:'2016', make:'Volvo' } ],
    defects:[ { cat:'1 - Driver Credentials', vehicle:2, kind:'OOS' } ] },
  { seq:19, date:'2018 OCT 17', time:'12:40', document:'OPI ONEA01251954',     jur:'ON', level:2, result:'Passed',             dateEntered:'2018 OCT 23', agency:'',                                              location:'WASSI NORTH TIS',    driver:'SIVALOGANATHAN NADESU 6550853 BC',
    vehicles:[ { type:'P',  plate:'E77384', jur:'AB', vin:'4V4NC9EH4GN929559', year:'2016', make:'Volvo' }, { type:'ST', plate:'R8098J', jur:'ON', make:'UTIL' } ], defects:[] },
  { seq:20, date:'2018 SEP 25', time:'13:56', document:'OPI ONEA01249644',     jur:'ON', level:2, result:'Passed',             dateEntered:'2018 OCT 02', agency:'',                                              location:'NEW LISKEARD TIS',   driver:'MOHAN SINGH M61600000720815 ON',
    vehicles:[ { type:'P',  plate:'E80652', jur:'AB', vin:'4V4NC9EH7EN152680', year:'2014', make:'Volvo' }, { type:'ST', plate:'P8978W', jur:'ON', make:'UTIL' } ], defects:[] },
  { seq:21, date:'2018 AUG 16', time:'21:45', document:'OPI ONEA01237362',     jur:'ON', level:2, result:'Passed',             dateEntered:'2018 AUG 28', agency:'',                                              location:'GANANOQUE SOUTH TIS',driver:'MIAN NISAR AHMED M500620055600 QC',
    vehicles:[ { type:'P',  plate:'E75062', jur:'AB', vin:'4V4NC9EH6DN133195', year:'2013', make:'Volvo' }, { type:'ST', plate:'P6331S', jur:'ON', make:'UTIL' } ], defects:[] },
  { seq:22, date:'2018 AUG 16', time:'16:23', document:'OPI 8605275',          jur:'BC', level:1, result:'Out of Service',     dateEntered:'2019 JAN 22', agency:'',                                              location:'KAMLOOPS',           driver:'SANDEEP SINGH DHALIWAL D3160-68988-89022 ON',
    vehicles:[ { type:'P',  plate:'E80652', jur:'AB', vin:'4V4NC9EH7EN152680', year:'2014', make:'Volvo' }, { type:'ST', plate:'M1695S', jur:'ON', make:'UTILITY' } ],
    defects:[ { cat:'3 - Brake Adjustment', vehicle:1, kind:'OOS' }, { cat:'1 - Driver Credentials', vehicle:1, kind:'REQ' }, { cat:'4 - Brake Systems', vehicle:2, kind:'REQ' }, { cat:'9 - Lighting Devices (Part II Section 8 OOSC only)', vehicle:1, kind:'REQ' }, { cat:'13 - Tires', vehicle:2, kind:'REQ' } ] },
  { seq:23, date:'2018 JUN 13', time:'22:30', document:'OPI ONEA01215795',     jur:'ON', level:2, result:'Passed',             dateEntered:'2018 JUN 26', agency:'',                                              location:'WASSI SOUTH TIS',    driver:'Harjinder Singh Gill 168548-543 AB',
    vehicles:[ { type:'P',  plate:'E65114', jur:'AB', vin:'4V4NC9EJ7FN180094', year:'2015', make:'Volvo' }, { type:'ST', plate:'P3361X', jur:'ON', make:'UTIL' } ], defects:[] },
  { seq:24, date:'2018 JUN 05', time:'08:50', document:'OPI ONEA01219694',     jur:'ON', level:1, result:'Requires Attention', dateEntered:'2018 JUN 12', agency:'',                                              location:'COCHRANE TIS',       driver:'Amrinder Singh Gill G43500408841006 ON',
    vehicles:[ { type:'P',  plate:'E65208', jur:'AB', vin:'1XPXD49X1JD467897', year:'2018', make:'Peterbilt' }, { type:'ST', plate:'R8066J', jur:'ON', make:'UTIL' } ],
    defects:[ { cat:'2 - Hours Of Service', vehicle:2, kind:'REQ' } ] },
  { seq:25, date:'2018 JUN 01', time:'02:24', document:'OPI ONEA01211359',     jur:'ON', level:2, result:'Requires Attention', dateEntered:'2018 JUN 12', agency:'',                                              location:'KENORA DISTRICT',    driver:'. Dilbag Singh 168893-048 AB',
    vehicles:[ { type:'P',  plate:'E65114', jur:'AB', vin:'4V4NC9EJ7FN180094', year:'2015', make:'Volvo' }, { type:'ST', plate:'M1729S', jur:'ON', make:'UTIL' } ],
    defects:[ { cat:'1 - Driver Credentials', vehicle:2, kind:'REQ' }, { cat:'4 - Brake Systems', vehicle:2, kind:'REQ' } ] },
];
...
const AB_COLLISION_META = {
  ...
  periodStart: '2017 OCT 01',
  periodEnd:   '2019 SEP 30',
  datePrinted: '2019 SEP 30',
  pages: '1 To 3',
};
...
// Industry block + thresholds taken from p.31 of the Sept-2019 PDF (Fleet Range 10, TRK).
...
const AB_MON_THRESHOLDS: AbMonThresholdRow[] = [
  { stage:'Stage 1', range:'1.830 - 2.464' },
  { stage:'Stage 2', range:'2.465 - 2.794' },
  { stage:'Stage 3', range:'2.795 - 3.899' },
  { stage:'Stage 4', range:'3.900 and higher' },
];

// 24 months — from 2017 OCT through 2019 SEP. Sept-2019 row is the "current"
// month at pull time (no fleet/score yet). Source: p.30 of the Sept-2019 PDF.
const AB_MON_SUMMARY: AbMonSummaryRow[] = [
  { date:'2019 SEP', type:'TRK', trkPct:'',     busPct:'',   avg:10, cur:0,  score:'No Data', convPct:'',      inspPct:'',      collPct:'',     stage:'' },
  ...
  { date:'2018 MAR', type:'TRK', trkPct:'100%', busPct:'0%', avg: 1, cur: 1, score:'No Data', convPct:'',      inspPct:'',      collPct:'',     stage:'' },
  { date:'2018 FEB', type:'TRK', trkPct:'',     busPct:'',   avg: 0, cur: 0, score:'No Data', convPct:'',      inspPct:'',      collPct:'',     stage:'' },
  { date:'2018 JAN', type:'TRK', trkPct:'',     busPct:'',   avg: 0, cur: 0, score:'No Data', convPct:'',      inspPct:'',      collPct:'',     stage:'' },
  { date:'2017 DEC', type:'TRK', trkPct:'',     busPct:'',   avg: 0, cur: 0, score:'No Data', convPct:'',      inspPct:'',      collPct:'',     stage:'' },
  { date:'2017 NOV', type:'TRK', trkPct:'',     busPct:'',   avg: 0, cur: 0, score:'No Data', convPct:'',      inspPct:'',      collPct:'',     stage:'' },
  { date:'2017 OCT', type:'TRK', trkPct:'',     busPct:'',   avg: 0, cur: 0, score:'No Data', convPct:'',      inspPct:'',      collPct:'',     stage:'' },
];

const AB_MON_DETAILS: AbMonDetailRow[] = [
  { date:'2019 SEP', avgFleet:10, convPtsVeh:'',     totalInsp:'', oosDefInsp:'',    totalDefInsp:'',    oosPct:'',    oosVeh:'',     failureRate:'',      collPtsVeh:''     },
  ...
  { date:'2017 DEC', avgFleet: 0, convPtsVeh:'',     totalInsp:'', oosDefInsp:'',    totalDefInsp:'',    oosPct:'',    oosVeh:'',     failureRate:'',      collPtsVeh:''     },
  { date:'2017 NOV', avgFleet: 0, convPtsVeh:'',     totalInsp:'', oosDefInsp:'',    totalDefInsp:'',    oosPct:'',    oosVeh:'',     failureRate:'',      collPtsVeh:''     },
  { date:'2017 OCT', avgFleet: 0, convPtsVeh:'',     totalInsp:'', oosDefInsp:'',    totalDefInsp:'',    oosPct:'',    oosVeh:'',     failureRate:'',      collPtsVeh:''     },
];
