...
const ALL_COLUMN_OPTIONS = [
  ...
  { id: 'telematicsTag', label: 'Telematics Tags' },
            ...
            <table className="min-w-full divide-y divide-slate-200">
              <thead className="bg-slate-50 select-none">
                <tr>
                  ...
                  {visibleColumns.has('telematicsTag') && <th scope="col" className="px-4 py-3 text-left text-xs font-bold text-slate-500 uppercase tracking-wider min-w-[200px]">
                    Telematics Tags
                  </th>}
