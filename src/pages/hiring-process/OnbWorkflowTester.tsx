...
import { ChevronLeft, ChevronRight, Check, PartyPopper, CheckCircle2, FileText, FileSignature, ClipboardList, ListChecks, PenLine } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { PolicyForm } from "./PolicyForm";
import { policyDocuments } from "./policy-forms.data";
import { getOnboardingFormDef, type OnbWorkflow } from "./onboarding.data";
...
const noop = () => {};
type StepKind = "policy" | "forms" | "documents" | "quizzes" | "checklist";
