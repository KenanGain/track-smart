...
const FORMS = [
    ...
    { id: "safety-performance-history", name: "Safety & Performance History", desc: "Previous-employer safety reference — employment summary, driving experience, equipment, U/S/G/E performance evaluation, plus incidents and violations.", Icon: ShieldCheck, accent: "bg-sky-50 text-sky-600" },
    { id: "old-safety-performance-history", name: "Old Safety & Performance History", desc: "The legacy Previous Employer & Safety History form (§391.23 / §40.25) — classic gray-table document layout.", Icon: FileText, accent: "bg-slate-100 text-slate-500" },
