...
const ROOT      = path.join(__dirname, '..', 'docs', 'cvor-extraction-vendor-package-v3');
...
const PDF_SPECS = [
  ...
  },
  {
    ...
    pull: makePullSpec({
      reportDate:'2024-11-04', periodLabel:'Nov 4/24', rating:14.20, colContrib:1.40, conContrib:2.10, insContrib:10.70,
      colPctOfThresh:3.50, conPctOfThresh:5.25, insPctOfThresh:53.50,
      collisionEvents:6, convictionEvents:8, oosOverall:18.50, oosVehicle:22.00, oosDriver:2.50,
      trucks:45, onMiles:4203400, canadaMiles:121800, totalMiles:4325200,
      collWithPoints:2, collWithoutPoints:4, totalCollisionPoints:6, convictionPoints:18,
      collisionDetails:{fatal:0,personalInjury:1,propertyDamage:5},
      convictionDetails:{withPoints:6,notPointed:2,driver:4,vehicle:2,load:1,other:1},
      levelStats:{level1:{count:18,oosCount:5},level2:{count:14,oosCount:3},level3:{count:11,oosCount:1},level4:{count:2,oosCount:0},level5:{count:1,oosCount:0}},
      inspectionStats:{cvsaInspections:46,vehiclesInspected:69,driversInspected:46,driverPoints:1,vehiclePoints:17,totalInspectionPoints:17.69,setThreshold:33.06},
      collisionBreakdown:[{events:3,points:3},{events:2,points:2},{events:1,points:1}],
      convictionBreakdown:[{events:4,points:8},{events:3,points:7},{events:1,points:3}],
    }),
  },
];
